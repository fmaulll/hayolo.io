...
//   }
    ...
    <div className="container">
        ...
        {/* Quiz List Section */}
        <div id="my-quizzes" className="mb-8 bg-white backdrop-blur-sm shadow-lg p-6 border-2 border-black">
        ...
        {showCreateModal && (
            ...
            <div className="bg-white p-6 rounded-none shadow-xl max-w-md w-full border-2 border-black">
                ...
                <div className="flex justify-end gap-3 pt-2">
                    ...
                    {isSubmitting ? (
                        <>
                        <div className="animate-spin rounded-none h-5 w-5 border-2 border-white"></div>
                        Creating...
                        </>
                    ) : (
                        <>
